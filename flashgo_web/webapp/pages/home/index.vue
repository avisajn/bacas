<template>
  <div class="homepage">
    ...
    <div class="wrap">
      <div class="wraptext">No more content</div>
    </div>
  </div>
</template>
<script type="text/javascript">
  ...
  import { commonGet, commonPost, commonFeedPost } from '~/ajax/api'
  ...
  export default {
    ...
    async asyncData({ req, res }) {
      ...
      const feeds = await commonFeedPost('sales/news/recommend?page_id=&count=55', '')
      return {
    ...
    methods: {
      ...
      getMoreData() {
        var self = this
        const newFeeds = commonFeedPost('sales/news/recommend?page_id=&count=55', '')
