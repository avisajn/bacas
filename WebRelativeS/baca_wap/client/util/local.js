module.exports =  {
  ...
  adClientId : 'ca-pub-1560928052349869',
  adSearchId : 'partner-pub-9683444248981364',

  // 巴西的配置
  bx : {
    webUrl : 'https://noticias.cennoticias.com/',  //访问巴西的基本地址
     interfaceUrl : 'https://api.cennoticias.com/api/v1', // 访问接口的地址
     trendingBase : 'https://api.cennoticias.com/api/v1',
    //interfaceUrl : 'https://testssl.cennoticias.com/api/v1', // 访问接口的地址
    //trendingBase : 'https://testssl.cennoticias.com/api/v1',
    interfaceLog : 'https://logging.cennoticias.com/api/logging',
    // 巴西的category接口
    interface_category : 'https://static.api.cennoticias.com/api/v1/category',
    imgHost : 'https://img.cdn.cennoticias.com/',
    imgHostOld : 'https://cennoticias.com/',
    adSearch : {
      adId : '7574213138',
      actionLink : 'https://www.google.com.br',
      link : 'https://www.google.com.br/cse?cx={adSearchId}:{adId}&ie=UTF-8&q={key}'
    },
    // ad : {
      // detail : '2190487538',
      // newsfeed : '1936795531',
	...
	ad : {
      detail : '9066755638',
      newsfeed : '3040882269',
      newsfeed300250 : '9533659499',
      detailContent : '2162914862', // 详情页－内容广告
    },
    language : {
  ...
  // 印尼的配置
  yn : {
    webUrl : 'https://berita.baca.co.id/',
    interfaceUrl : 'https://www.baca.co.id/api/v1',
    trendingBase : 'https://www.baca.co.id/api/v1',
    interfaceLog : 'https://logging.baca.co.id/api/logging',
    // 印尼的cateogry的接口
    interface_category : 'https://static.api.baca.co.id/api/v1/category',
    imgHost : 'https://img.cdn.baca.co.id/',
    imgHostOld : 'https://baca.co.id/',
    adSearch : {
      adId : '8295896732',
      actionLink : 'https://www.google.co.id',
    ...
    language : {
        ...
        'downloadBlock' : 'DOWNLOAD BACA PLUS, ADA HADIAHNYA!' , // 详情页，下载块
  ...
  // 中东的配置
  me : {
    webUrl : 'http://www.menanip.com/',
    // interfaceUrl : 'http://www.baca.co.id/api/v1',
    
    interfaceUrl : 'http://api.menanip.com/api/v1',
    trendingBase : 'http://api.menanip.com/api/v1',
    interfaceLog : 'http://logging.menanip.com/api/logging',
    // 印尼的cateogry的接口
    interface_category : 'http://static.api.menanip.com/api/v1/category',
    imgHost : 'http://img.cdn.menanip.com/',
    imgHostOld : 'http://menanip.com/',
    adSearch : {
      adId : '8295896732',
