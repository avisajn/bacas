define(function (require, exports, module) {
	...
	var tpl = `
		<div class="top">
			...
			<p class="footer">
				<img src="http://img.cdn.baca.co.id/favicon.ico" alt="" />
				<span>Dari Baca </span>
				<img decoding="async" src="/images/icon_zan.png" id="like" class="i-amphtml-fill-content i-amphtml-replaced-content">
				<span class="monuts"><%=mounts_tpl%></span>
			</p>
			<div class="share_block"></div>
			<div class="ul">
				<ul>
	                <li>
						<a target="_blank" href="javascript:window.shareClick.shareTo('whatsapp');"><img src="/images/icon_share_whatapp.png" alt="" /></a>
	                </li>
	                <li>
	                	<a target="_blank" href="javascript:window.shareClick.shareTo('facebook');"><img src="/images/icon_share_facebook.png" alt="" /></a>
	                </li>
	                <li>
	                	<a target="_blank" href="javascript:void(0);"><img src="/images/icon_share_hike.png" alt="" /></a>
	                </li>
	                <li>
	                	<a target="_blank"  href="javascript:window.shareClick.shareTo('facebook');"><img src="/images/icon_share_twitter.png" alt="" /></a>
	                </li>
	            </ul>
			</div>
			<div class="li">
		...
		<div class=" content_block">
                <div class="rel_list">Related news</div>
                <div class="data_list">
                    <ul class="ul">
                    	<li>
                    		<a id="li" href="/27492391">Begini Konsep Pernikahan Muzdalifah dan Fadel Islami</a>
                    	</li>
						<div id="ad-content" style="background: #EBEBEB; position: relative; padding: 5px 0 20px 0;">
							<sapn style="font-size: 13px; padding: 0px 0px 10px 15px; ">Ad</sapn>
							...
							<style>
								html,body{margin:0px auto;height:100%;width:100%;} #img-overlay-1{ position:absolute;top:0;height:100%;width:50%;left:25%;visibility: hidden; } #img-overlay-2{ position:absolute;top:0;height:100%;width:35%;left:32.5%;visibility: hidden; } #img-overlay-0{ position:absolute;top:0;height:100%;width:100%;left:0;visibility: hidden; }
							</style>
                    	...
                    	<li>
                    		<a id="li" href="/27450522">Muzdalifah Jawab Doa Nassar, Begini Ekspresi Fadel Islami Saat Dituding Cuma Incar Harta</a>
                    	</li>
                    	<li>
                    		<a id="li" href="/27446842">Muzdalifah Jawab Doa Nassar, Ekspresi Fadel Islami Saat Dituding Jedar Cuma Incar Harta Jadi Sorotan</a>
                    	</li>
                    	<li>
                    		<a id="li" href="javascript:void(0);27446842">Vokalis Gambus Cantik Nissa Sabyan Digendong Petugas, Videonya Beredar</a>
                    	</li>
                    </ul>
                </div>
        </div>
		...
		$.ajax({
			...
			success: function (data) {
				...
				$like.onclick = function() {
					$("#like").attr("src", "/images/icon_zan_select.png");
				}
				...
				// $zan_like.onclick = function() {
				// 	$("#zan_like").attr("src", "/images/icon_zan_select.png");
				// }
				// $("#zan_like").one("click", function() {
				// 	$(".lit").html(++ y);
				// })
				//点击加载更多部分
			}
