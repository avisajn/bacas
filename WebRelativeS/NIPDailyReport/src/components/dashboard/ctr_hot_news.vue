<template>
    <tb-panel>
        <div slot="title"><a href="javascript:window.toLink('/ctr_hot_news_chart');">热门新闻点击率统计</a></div>
        <div slot="table">
            <i-table 
            ...
            return {
                columns: [
                    {title: '类名', key: '_name',sortable: 'custom' ,render(r){
                        return `<a href="javascript:window.toLink('/ctr_hot_news_chart?c=${r._name}')">${r._name}</a>`;
                    }},
                    {title: '展示数', key: 'hotTagFetch',sortable: 'custom'},
                    {title: '算法占比', key: 'percent',sortable: 'custom'},
                    {title: '阅读数', key: 'hotTagRead',sortable: 'custom'},
