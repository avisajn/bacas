    ...
    <layout-main>
        <query-layout slot="main">
            <div slot="condition" class="condition">  
                <span class="title">新闻抓取统计 - 图表</span>
    ...
    export default {
        data(){
            return {
                ...
                chartTitle : '',
                mapping : [
                    { key:'FunnyPictures'      , text: 'FunnyPictures'      , color:'#993333'},
                    { key:'Gallery'    , text: 'Gallery'    , color:'#CCCC00'},
                    { key:'Joke'       , text: 'Joke'       , color:'#663366'},
                    { key:'News'       , text: 'News'      , color:'#336633'},
                    { key:'Video'     , text: 'Video'    , color:'#333333'},
                ],
                comparison : false,
                charts : {
                    checked : ['FunnyPictures'],
                    width : _config.width ,
        ...
        methods : {
            ...
            async onSearch(){
                ...
                const e = await API.newsCrawled(range[0] ,range[1]);
                this.data = e.data;
