    ...
    <layout-main>
        <query-layout slot="main">
            <div slot="condition" class="condition">  
                <span class="title">新用户点击率统计</span>
    ...
    export default {
        data(){
            return {
                ...
                chartTitle : '',
                mapping : [
                    { key:'freshTagFetch'       , text: '展示数'      , color:'#993333'},
                    { key:'percent'       , text: '算法占比'      , color:'#CCCC00'},
                    { key:'freshTagRead'       , text: '阅读数'      , color:'#663366'},
        ...
        methods : {
            ...
            async onSearch(){
                ...
                const e = await API.freshUsersCtr(range[0] ,range[1]);
