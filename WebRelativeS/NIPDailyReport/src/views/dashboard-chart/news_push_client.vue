    ...
    export default {
        data(){
            return {
                ...
                chartTitle : '',
                mapping : [
                    { key:'validPushCount'      , text: '总推送数'      , color:'#993333'},
                    { key:'validPushSuccess'    , text: '推送到达数'    , color:'#CCCC00'},
                    { key:'validPushClick'       , text: '推送阅读数'       , color:'#663366'},
        ...
        methods : {
            ...
            async onSearch(){
                ...
                const e = await API.newsPushedNewClientChart(range[0] ,range[1]);
                this.data = e.data;
