    ...
    <layout-main>
        <query-layout slot="main">
            <div slot="condition" class="condition">  
                <span class="title">新闻数据统计 - 图表</span>
    ...
    export default {
        data(){
            return {
                ...
                chartTitle : '',
                mapping : [
                    {text: '抓取新闻数', key: 'crawledNews', color:'#993333'},
                    {text: '含相关新闻的新闻比例', key: 'relativeRatio', color:'#CCCC00'},
                    {text: '展示新闻数', key: 'displayedNews', color:'#663366'},
                    {text: '点击新闻数', key: 'readNews', color:'#336633'},
                    {text: '总展示次数', key: 'displayCount', color:'#333333'},
                    {text: '总点击次数', key: 'readCount', color:'#333399'},
                ],
                comparison : false,
                charts : {
                    checked : ['crawledNews'],
        ...
        methods : {
            ...
            async onSearch(){
                ...
                const e = await API.news(range[0] ,range[1]);
                this.data = e.data;
