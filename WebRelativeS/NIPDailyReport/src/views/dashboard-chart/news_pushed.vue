    ...
    <layout-main>
        <query-layout slot="main">
            <div slot="condition" class="condition">  
                <span class="title">推送新闻统计 - 图表</span>
    ...
    export default {
        data(){
            return {
                ...
                chartTitle : '',
                mapping : [
                    { key:'newsToPush'      , text: '推送新闻数'      , color:'#993333'},
                    { key:'totalPushCount'    , text: '总推送数'    , color:'#CCCC00'},
                    { key:'totalPushReadCount'       , text: '推送阅读数'       , color:'#663366'},
                    { key:'pushReadRatio'       , text: '推送点击率'      , color:'#336633'},
                    { key:'totalNormalReadCount'     , text: '非推送阅读数'    , color:'#333333'},
                ],
                comparison : false,
                charts : {
                    checked : ['newsToPush'],
        ...
        methods : {
            ...
            async onSearch(){
                ...
                const e = await API.newsPushed(range[0] ,range[1]);
                this.data = e.data;
