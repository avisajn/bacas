    ...
    <layout-main>
        <query-layout slot="main">
            <div slot="condition" class="condition">  
                <span class="title">新闻类型点击率统计</span>
    ...
    export default {
        data(){
            return {
                ...
                chartTitle : '',
                mapping : [
                    { key:'newsTypeFetch'    , text: '展示数'    , color:'#CCCC00'},
                    { key:'newsTypeRead'       , text: '阅读数'       , color:'#663366'},
        ...
        methods : {
            ...
            async onSearch(){
                ...
                const e = await API.newsTypeCtr(range[0] ,range[1]);
