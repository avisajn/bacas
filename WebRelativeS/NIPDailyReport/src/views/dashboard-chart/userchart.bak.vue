    ...
    <layout-main>
        <query-layout slot="main">
            <div slot="condition" class="condition">  
                <span class="title">用户数据统计 - 图表</span>
    ...
    export default {
        data(){
            return {
                ...
                chartTitle : '',
                mapping : [
                    { key:'activeUser'      , text: '活跃用户'      , color:'#993333'},
                    { key:'readNewsUser'    , text: '读新闻用户'    , color:'#CCCC00'},
                    { key:'freshUser'       , text: '新用户'       , color:'#663366'},
                    { key:'loginUser'       , text: '登陆用户'      , color:'#336633'},
                    { key:'loginRation'     , text: '登陆用户比例'    , color:'#333333'},
                    { key:'commentUser'     , text: '评论用户'      , color:'#333399'},
                    { key:'totalComments'   , text: '总评论数'      , color:'#0099CC'},
                ],
                charts : {
                    checked : ['activeUser'],
                    width : _config.width ,
        ...
        methods : {
            ...
            async onSearch(){
                ...
                const e = await API.user(range[0] ,range[1]);
                this.data = e.data;
            ...
            setOption(){
                ...
                console.log('this.charts.checkedL',this.charts.checked);
