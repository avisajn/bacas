...
$(function(){
	...
	// layer.open({
	// 		content: $('#page3').html(),
	// 		style: 'position:fixed; left:0; top:0; width:100%; height:100%; border: none; -webkit-animation-duration: .2s; animation-duration: .2s;background:#f5f5f5;',
	...
	layer.open({
		...
		style: 'position:fixed; left:0; top:0; width:100%; height:100%; border: none; -webkit-animation-duration: .2s; animation-duration: .2s;background:white;',
	...
	$('body').on('clickover' ,'.btn-form-submit-next' ,function(){
		...
		if(!obj['name']){layer.open({content: 'Name is required',skin: 'msg',time: 2 }); return; }
